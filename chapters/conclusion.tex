...
\begin{enumerate}
    ...
    \item Evaluate \ac{bitdf} in animal mobility datasets, like those from Movebank Database \citep{movebank}.
\end{enumerate}
...
entries, such pre-processing should be done in a way that does not compromise the accuracy nor the effiency of the
