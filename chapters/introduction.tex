...
% * <steniofernandes@gmail.com> 2016-05-27T11:16:07.536Z:
%
% > academia
%
% the correct term is academia , not academy, which graduate police and firefighter officers :-) olha no resto do texto pra se tem outras ocorrências.
%
% ^.
...
Among those collaborative patterns, the flock pattern is one that has gained a lot of attention in the research community, since it
% * <steniofernandes@gmail.com> 2016-05-27T11:19:54.364Z:
%
% police academy 2: vc pode trocar também por research community. lembre que empresas fazem pesquisa também. então a comunidade engloba both industry and academia researchers
%
% ^.
...
\figref{fig:flocks}. The figure shows a flock pattern that lasts three time steps and is formed by trajectories $T_1$,
...
Despite the considerable number of research studies regarding flock pattern detection, there is still a
problem that remains open, besides the fast pattern detection that we already mentioned: A framework/system architecture
% * <steniofernandes@gmail.com> 2016-05-27T11:22:26.308Z:
%
% > problem
%
% não é be um problema e sim uma necessidade. reformule a frase
%
% ^.
...
Last, but not least, we also propose a Generic System Architecture that can be used to solve a great number of data mining
