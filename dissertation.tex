...
\captionsetup[figure]{position=top,justification=centering,width=.85\textwidth,labelfont=bf,font=footnotesize}
...
\usepackage[linkcolor=black,
            ...
            pdfauthor={Thiago de Barros Lacerda}
...
\frstcmtmember{Rostand Edson Oliveira Costa}{Laboratório de Aplicações de Vídeo Digital - LAVID/UFPB}
\scndcmtmember{Kiev Santos da Gama}{Centro de Informática/UFPE}
\thrdcmtmember{Stênio Flávio de Lacerda Fernandes}{Centro de Informática/UFPE}
...
\begin{epigraph}[]{Led Zeppelin, Stairway to Heaven}
